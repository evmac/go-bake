...
TargetBody = (DepsClause | WhenClause | StepsBlock | EnvBlock | ArgsClause | CwdClause | DescClause | TagsClause | PassthroughClause | InputsClause | OutputsClause | PresetBlock | PrivateLine | PoolClause | MutexClause)*
